#!/usr/bin/env python3
"""Run holdout4096 confirmation for transfer-selected deadzone014."""
...
def result_prefix(seed: int) -> Path:
    return ANALYSIS / f"e109_deadzone014_from_beta005_seed{seed}_step250_fullimage_holdout4096_current"
...
def main() -> None:
    ...
    for seed in SEEDS:
        ...
        if json_path.exists():
            ...
            print(f"skip seed={seed}: {summary.get('mean_rd_minus_reference')}")
            continue
        ...
        reference = f"experiments/analysis/beta005_after250_seed{seed}_direct_exact_step500_holdout4096_current.csv"
        cmd = [
            sys.executable,
        ...
        print(f"run seed={seed} deadzone014 holdout4096")
        ...
        print(
            f"done seed={seed}: delta={summary.get('mean_rd_minus_reference')} "
