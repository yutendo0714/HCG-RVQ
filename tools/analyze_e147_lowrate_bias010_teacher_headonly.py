#!/usr/bin/env python3
"""Evaluate E147 low-rate bias010 strong teacher-head reliability controller on holdout4096."""
...
BASE_PREFIX = ANALYSIS / "e147_lowrate_bias010_teacher_headonly_rho20_lr005_holdout4096"
...
SEED = "3456"
RUN_NAME = "pilot_hcg_rvq_h_gate025_bias010_teacher_transfer8192_relmin000_rho20_headonly_lr005_g64_l1_k128_lambda0018_seed3456"
CONFIG = ROOT / "configs/pilot_hcg_rvq_h_gate025_bias010_teacher_transfer8192_relmin000_rho20_headonly_lr005_lambda0018_seed3456.yaml"
...
def output_prefix(max_images: int, start_index: int) -> Path:
    if max_images == DEFAULT_MAX_IMAGES and start_index == DEFAULT_START_INDEX:
        return BASE_PREFIX
    return ANALYSIS / f"e147_lowrate_bias010_teacher_headonly_rho20_lr005_start{start_index}_n{max_images}"
...
def write_markdown(prefix: Path, result: dict[str, object]) -> None:
    ...
    lines = [
        "# E147 Low-Rate Bias010 Strong Teacher-Head Reliability Controller",
        "",
...
def main() -> None:
    ...
    result = {
        "experiment": "E147 low-rate bias010 strong teacher-head reliability controller",
        "seed": SEED,
        "run_name": RUN_NAME,
