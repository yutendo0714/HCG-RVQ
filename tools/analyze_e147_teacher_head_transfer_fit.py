#!/usr/bin/env python3
"""Audit whether the E147 strong teacher-head learned its transfer-split labels."""
...
BASE_PREFIX = ANALYSIS / "e147_lowrate_bias010_teacher_headonly_rho20_lr005_transfer8192_fit"
...
def output_prefix(max_images: int, start_index: int) -> Path:
    if max_images == DEFAULT_MAX_IMAGES and start_index == DEFAULT_START_INDEX:
        return BASE_PREFIX
    return ANALYSIS / f"e147_lowrate_bias010_teacher_headonly_rho20_lr005_transfer_fit_start{start_index}_n{max_images}"
...
def main() -> None:
    ...
    result = {
        "experiment": "E147 transfer-fit audit",
        "seed": SEED,
        "run_name": RUN_NAME,
