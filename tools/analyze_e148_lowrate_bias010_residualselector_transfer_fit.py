#!/usr/bin/env python3
"""Audit E148 low-rate bias010 exact-default residual selector on transfer labels."""
...
BASE_PREFIX = ANALYSIS / "e148_lowrate_bias010_residualselector_transfer8192_suppress_rho100_yhatanchor50_deadzone014_fit"
...
CONFIG = ROOT / "configs/pilot_hcg_rvq_h_gate025_bias010_residualselector_transfer8192_suppress_rho100_yhatanchor50_deadzone014_lambda0018_seed3456.yaml"
...
def write_markdown(prefix: Path, by_step: list[dict[str, object]]) -> None:
    lines = [
        "# E148 Low-Rate Bias010 Residual Selector Transfer-Fit Audit",
        "",
